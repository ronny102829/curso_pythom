...
# proceso que desea automatizar con un sistema infromatico, las acciones que puede realizar el empresario son ver las lista de autos que tiene, podra tambien actualizar la lista y agregar un nuevo vehiculo
# casos de uso
#programacion
